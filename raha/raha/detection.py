...
class Detection:
    ...
    def __init__(self):
        ...
        # ["ABC", "DTC", "GBC", "GNB", "SGDC", "SVC"]
        self.CLASSIFICATION_MODEL = "GBC"
        # ["homogeneity", "majority"]
        self.LABEL_PROPAGATION_METHOD = "homogeneity"
        # ["OD", "PVD", "RVD", "KBVD", "TFIDF"]
        self.ERROR_DETECTION_ALGORITHMS = ["OD", "PVD", "RVD", "KBVD"]
    ...
    def _strategy_runner_process(self, args):
        ...
        if len(args) == 3:
            ...
            d, algorithm, configuration, column_list = args
        ...
        if algorithm == "OD":
            ...
            if len(args) == 3:
                ...
                d.write_csv_dataset(dataset_path, d.dataframe.loc[:, column_list])
            params = (
                ["-F", ",", "--statistical", "0.5"]
                + ["--" + configuration[0]]
                + configuration[1:]
    ...
    def run_strategies(self, d):
        ...
        if not self.STRATEGY_FILTERING:
            ...
            if os.path.exists(sp_folder_path):
                ...
                os.mkdir(sp_folder_path)
                (
                    good_strategies_algorithm_and_configurations,
                    selected_strategy_profiles,
                ) = utilities.get_selected_strategies_via_historical_data(
                    d.dictionary, self.HISTORICAL_DATASETS
                )
                # print(good_strategies_algorithm_and_configurations)
                # print(selected_strategy_profiles)

                pool = multiprocessing.Pool()
                strategy_profiles_list = pool.map(
                    self._strategy_runner_process,
                    good_strategies_algorithm_and_configurations,
                )
                raha.utilities.evaluation_profiler(d.dictionary)

                # Save selected_strategy_profiles in "selected-strategy" folder
                ss_folder_path = os.path.join(d.results_folder, "selected-strategy")
                os.mkdir(ss_folder_path)
                for strategy_profile in selected_strategy_profiles:
                    strategy_name = (
                        strategy_profile["name"]
                        + strategy_profile["new_column"]
                    ...
                    pickle.dump(
                        ...
                        open(
                            os.path.join(
                                ss_folder_path, strategy_name_hash + ".dictionary"
                            ),
                            "wb",
                        ),
                    )
    ...
    def build_clusters(self, d):
        ...
        for j in range(d.dataframe.shape[1]):
            ...
            extra_feature = numpy.ones((feature_vectors.shape[0], 1))
            feature_vectors = numpy.hstack((feature_vectors, extra_feature))
...
if __name__ == "__main__":
    ...
    app.HISTORICAL_DATASETS = [
        {
            "name": "beers",
            "path": "/Users/xygong/LUH/raha/datasets/beers/dirty.csv",
            "clean_path": "/Users/xygong/LUH/raha/datasets/beers/clean.csv",
        },
        {
            "name": "rayyan",
            "path": "/Users/xygong/LUH/raha/datasets/rayyan/dirty.csv",
            "clean_path": "/Users/xygong/LUH/raha/datasets/rayyan/clean.csv",
        },
        {
            "name": "flights",
            "path": "/Users/xygong/LUH/raha/datasets/flights/dirty.csv",
            "clean_path": "/Users/xygong/LUH/raha/datasets/flights/clean.csv",
        },
        {
            "name": "hospital",
            "path": "/Users/xygong/LUH/raha/datasets/hospital/dirty.csv",
            "clean_path": "/Users/xygong/LUH/raha/datasets/hospital/clean.csv",
        },
    ]
